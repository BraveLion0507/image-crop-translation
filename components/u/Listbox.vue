...
const optionsHeight = computed(() =>
  Math.min(window.innerHeight - optionsTop.value - 16, 240)
);
const toTop = computed(
  () =>
    optionsHeight.value < 200 && optionsTop.value > 240 + rootPos.height.value
);
</script>
...
<template>
  <HListbox v-slot="{ open }" v-model="modelValue">
    ...
    <div ref="rootEl" class="mt-1" :class="props.class">
      <HListboxButton
        class="focus:outline-none relative w-full py-1 pl-4 pr-8 rounded-full text-left shadow-sm ring-1 ring-fuchsia-300 dark:ring-gray-700 focus-visible:ring-offset-1 focus-visible:ring-offset-fuchsia-400 dark:focus-visible:ring-offset-gray-500"
      >
        <span class="block truncate">{{ items[modelValue] }}</span>
        <span
          class="pointer-events-none absolute flex inset-y-0 right-0 pr-2 items-center"
        >
          <span
      ...
      <Teleport to="body">
        ...
        >
          <Transition
            ...
            :enter-from-class="`${
              toTop ? 'translate-y-1/3' : '-translate-y-1/3'
            } opacity-40`"
            ...
            >
              ...
              >
                <li
                  ...
                  :class="
                    active
                      ? 'bg-fuchsia-50 text-fuchsia-900 dark:bg-indigo-900 dark:text-fuchsia-50'
                ...
                >
                  ...
                  <span
                    ...
                    ><span class="i-ri:check-line h-4 w-4" aria-hidden="true"
                  /></span>
                </li>
              </HListboxOption>
            </HListboxOptions>
